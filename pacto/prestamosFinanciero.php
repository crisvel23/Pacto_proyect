        ...
        <div class="panel  panel-default">
			...
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px; padding-left:20px;">
					<a class="btn btn-default button1" type="button" data-toggle="modal" id="cateModalBtn" data-target="#addCateModal"> <i class="fas fa-plus"></i> Agregar Préstamo </a>
				</div> <!-- /div-action -->
